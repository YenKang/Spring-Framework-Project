...
public class TibameHelloServlet extends HttpServlet {
	...
	private ClassPathXmlApplicationContext factory = new ClassPathXmlApplicationContext("applicationContext.xml"); 
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ITibameHello hello = factory.getBean("tibamehello", ITibameHello.class);
